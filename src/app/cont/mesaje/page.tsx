...
export default async function MessagesPage() {
  ...
  return <main id="main-content" className="app-page chat-page flex justify-center px-4 py-2 sm:px-6 sm:py-4"><div className="flex min-h-0 w-full max-w-6xl flex-col gap-3">
    <div className="flex shrink-0 flex-wrap items-center justify-between gap-2"><h1 className="text-3xl font-semibold">Mesaje</h1><BackLink href="/cont">Înapoi la cont</BackLink></div>
